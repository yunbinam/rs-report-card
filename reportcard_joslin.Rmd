...
```{r}
joslin1 = format_rct_kable(data, site = "joslin", type = "ckd",
                           current_quarter = current_quarter, previous_quarter = previous_quarter,
                           goal = goal_joslin, goal1=goal_brigham, goal2=goal_ccf, goal3=goal_joslin, goal4=goal_utsw)

kbl(joslin1$kb, linesep="", booktabs=T, align=c("l", rep("c",5)), escape=F,
    col.names=linebreak(c("Joslin", "Current\nQuarter\n3/2/2021 -\n6/4/2021", "Previous\nQuarter\n12/1/2020 -\n3/1/2021", "Change", "Cumulative", "All CKD Sites\n(Range)"), align="c")) %>%
...
```{r}
joslin2 = format_crfs_kable(data, site = "joslin", type = "ckd",
                            current_quarter = current_quarter, previous_quarter = previous_quarter)
